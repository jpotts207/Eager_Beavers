...
echo '<script type="text/javascript">',
    '$(document).ready(function(){',
        '$("#friendRemovedModal").modal("toggle");',
    '});',
'</script>';
?>

<div id="friendRemovedModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Friend Removed</h4>
            </div>
            <div class="modal-body">
                <?php
                echo '<p>shhh...we wont tell '.$friend->getFirstName().'</p>';
                ?>
            </div>
